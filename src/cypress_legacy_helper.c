...
// ******************************************************************************************
//
// \file cypress_legacy_helper.c   Implementation for Cypress Legacy USB
// Pass-through CDBs
...
eReturnValues build_Cypress_Legacy_CDB(uint8_t cdb[16], ataPassthroughCommand* ataCommandOptions)
{
    ...
    // set register select to 0xFF for all registers. (we can change this later to
    // set bits based on what registers we actually use)
    cdb[3] = 0xFF;
