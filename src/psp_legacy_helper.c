...
// ******************************************************************************************
//
// \file psp_legacy_helper.c   Implementation for PSP Legacy USB Pass-through
// CDBs
                                        ...
                                        eReturnValues          commandRet)
{
    ...
    // Set the device register in offset 7 for selecting device 0 vs device 1...we
    // won't do that at this time - TJE send the command
