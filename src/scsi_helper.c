...
ascAscqRetDesc ascAscqLookUp[] = {
    ...
    {0x00, 0x06, (int)FAILURE,       "I/O Process Terminated"},
    {0x00, 0x07, -1,                 "Programmable Early Warning Detected"},
    {0x00, 0x11, (int)IN_PROGRESS,   "Audio Play Operation In Progress"},
    {0x00, 0x12, -1,                 "Audio Play Operation Paused"},
    {0x00, 0x13, (int)SUCCESS,       "Audio Play Operation Successfully Completed"},
    {0x00, 0x14, (int)FAILURE,       "Audio Play Operation Stopped Due To Error"},
    {0x00, 0x15, -1,                 "No Current Audio Status To Return"},
    {0x00, 0x16, (int)IN_PROGRESS,   "Operation In Progress"},
    {0x00, 0x17, (int)UNKNOWN,       "Cleaning Requested"},
    {0x00, 0x18, (int)IN_PROGRESS,   "Erase Operation In Progress"},
    {0x00, 0x19, (int)IN_PROGRESS,   "Locate Operation In Progress"},
    {0x00, 0x1A, (int)IN_PROGRESS,   "Rewind Operation In Progress"},
    {0x00, 0x1B, (int)IN_PROGRESS,   "Set Capacity Operation In Progress"},
    {0x00, 0x1C, (int)IN_PROGRESS,   "Verify Operation In Progress"},
    {0x00, 0x1D, (int)UNKNOWN,       "ATA Passthrough Information Available"},
    {0x00, 0x1E, (int)UNKNOWN,       "Conflicting SA Creation Request"},
    {0x00, 0x1F, (int)SUCCESS,       "Logical Unit Transitioning To Another Power Condition"},
    {0x00, 0x20, (int)SUCCESS,       "Extended Copy Information Available"},
    {0x00, 0x21, (int)FAILURE,       "Atomic Command Aborted Due To ACA"},
    {0x01, 0x00, (int)FAILURE,       "No Index/Sector Signal"},
    {0x02, 0x00, (int)FAILURE,       "No Seek Complete"},
    {0x03, 0x00, (int)FAILURE,       "Peripheral Device Write Fault"},
    {0x03, 0x01, (int)FAILURE,       "No Write Current"},
    {0x03, 0x02, (int)FAILURE,       "Excessive Write Errors"},
    {0x04, 0x00, (int)FAILURE,       "Logical Unit Not Ready, Cause Not Reported"},
    {0x04, 0x01, (int)FAILURE,       "Logical Unit Is In The Process Of Becoming Ready"},
    {0x04, 0x02, (int)FAILURE,       "Logical Unit Not Ready, Initializing Command Required"},
    {0x04, 0x03, (int)FAILURE,       "Logical Unit Not Ready, Manual Intervention Required"},
    {0x04, 0x04, (int)IN_PROGRESS,   "Logical Unit Not Ready, Format In Progress"},
    {0x04, 0x05, (int)IN_PROGRESS,   "Logical Unit Not Ready, Rebuild In Progress"},
    {0x04, 0x06, (int)IN_PROGRESS,   "Logical Unit Not Ready, Recalculation In Progress"},
    {0x04, 0x07, (int)IN_PROGRESS,   "Logical Unit Not Ready, Operation In Progress"},
    {0x04, 0x09, (int)IN_PROGRESS,   "Logical Unit Not Ready, Self-Test In Progress"},
    {0x04, 0x0A, (int)FAILURE,       "Logical Unit Not Accessible, Asymetric Access State Transition"},
    {0x04, 0x0B, (int)FAILURE,       "Logical Unit Not Accessible, Target Port In Standby State"},
    {0x04, 0x0C, (int)FAILURE,       "Logical Unit Not Accessible, Target Port in Unavailable State"},
    {0x04, 0x0D, (int)FAILURE,       "Logical Unit Not Ready, Structure Check Required"},
    {0x04, 0x0E, (int)FAILURE,       "Logical Unit Not Ready, Security Session In Progress"},
    {0x04, 0x10, (int)FAILURE,       "Logical Unit Not Ready, Auxilary Memory Not Accessible"},
    {0x04, 0x11, (int)FAILURE,       "Logical Unit Not Ready, Notify (Enable Spinup) Required"},
    {0x04, 0x13, (int)IN_PROGRESS,   "Logical Unit Not Ready, SA Creation In Progress"},
    {0x04, 0x14, (int)IN_PROGRESS,   "Logical Unit Not Ready, Space Allocation In Progress"},
    {0x04, 0x15, (int)FAILURE,       "Logical Unit Not Ready, Robotics Disabled"},
    {0x04, 0x16, (int)FAILURE,       "Logical Unit Not Ready, Configuration Required"},
    {0x04, 0x17, (int)FAILURE,       "Logical Unit Not Ready, Calibration Required"},
    {0x04, 0x18, (int)FAILURE,       "Logical Unit Not Ready, A Door Is Open"},
    {0x04, 0x19, (int)IN_PROGRESS,   "Logical Unit Not Ready, Operating In Sequential Mode"},
    {0x04, 0x1A, (int)IN_PROGRESS,   "Logical Unit Not Ready, Start Stop Unit Command In Progress"},
    {0x04, 0x1B, (int)IN_PROGRESS,   "Logical Unit Not Ready, Sanitize In Progress"},
    {0x04, 0x1C, (int)FAILURE,       "Logical Unit Not Ready, Additional Power Use Not Yet Granted"},
    {0x04, 0x1D, (int)IN_PROGRESS,   "Logical Unit Not Ready, Configuration In Progress"},
    {0x04, 0x1E, (int)FAILURE,       "Logical Unit Not Ready, Microcode Activation Required"},
    {0x04, 0x1F, (int)FAILURE,       "Logical Unit Not Ready, Microcode Download Required"},
    {0x04, 0x20, (int)FAILURE,       "Logical Unit Not Ready, Logical Unit Reset Required"},
    {0x04, 0x21, (int)FAILURE,       "Logical Unit Not Ready, Hard Reset Required"},
    {0x04, 0x22, (int)FAILURE,       "Logical Unit Not Ready, Power Cycle Required"},
    {0x04, 0x23, (int)FAILURE,       "Logical Unit Not Ready, Affiliation Required"},
    {0x05, 0x00, (int)FAILURE,       "Logical Unit Does Not Respond To Selection"},
    {0x06, 0x00, (int)FAILURE,       "No Reference Position Found"},
    {0x07, 0x00, (int)FAILURE,       "Multiple Peripheral Devices Selected"},
    {0x08, 0x00, (int)FAILURE,       "Logical Unit Communication Failure"},
    {0x08, 0x01, (int)FAILURE,       "Logical Unit Communication Time-Out"},
    {0x08, 0x02, (int)FAILURE,       "Logical Unit Communication Parity Error"},
    {0x08, 0x03, (int)FAILURE,       "Logical Unit Communication CRC Error (Ultra-DMA/32)"},
    {0x08, 0x04, (int)FAILURE,       "Unreachable Copy Target"},
    {0x09, 0x00, (int)FAILURE,       "Track Following Error"},
    {0x09, 0x01, (int)FAILURE,       "Tracking Servo Failure"},
    {0x09, 0x02, (int)FAILURE,       "Focus Servo Failure"},
    {0x09, 0x03, (int)FAILURE,       "Spindle Servo Failure"},
    {0x09, 0x04, (int)FAILURE,       "Head Select Fault"},
    {0x09, 0x05, (int)FAILURE,       "Vibration Induced Tracking Error"},
    {0x0A, 0x00, (int)FAILURE,       "Error Log Overflow"},
    {0x0B, 0x00, -1,                 "Warning"},
    ...
    {0x0C, 0x00, (int)FAILURE,       "Write Error"},
    {0x0C, 0x01, -1,                 "Write Error - Recovered With Auto Reallocation"},
    {0x0C, 0x02, (int)FAILURE,       "Write Error - Auto Reallocation Failed"},
    {0x0C, 0x03, (int)FAILURE,       "Write Error - Recommend Reassignment"},
    {0x0C, 0x04, (int)FAILURE,       "Compression Check Miscompare Error"},
    {0x0C, 0x05, (int)FAILURE,       "Data Expansion Occurred During Compression"},
    {0x0C, 0x06, (int)FAILURE,       "Block Not Compressible"},
    {0x0C, 0x07, (int)FAILURE,       "Write Error - Recovery Needed"},
    {0x0C, 0x08, (int)FAILURE,       "Write Error - Recovery Failed"},
    {0x0C, 0x09, (int)FAILURE,       "Write Error - Loss Of Streaming"},
    {0x0C, 0x0A, (int)FAILURE,       "Write Error - Padding Blocks Added"},
    {0x0C, 0x0B, (int)FAILURE,       "Auxiliary Memory Write Error"},
    {0x0C, 0x0C, (int)FAILURE,       "Write Error - Unexpected Unsolicited Data"},
    {0x0C, 0x0D, (int)FAILURE,       "Write Error - Not Enough Unsolicited Data"},
    {0x0C, 0x0E, (int)FAILURE,       "Multiple Write Errors"},
    {0x0C, 0x0F, (int)FAILURE,       "Defects In Error Window"},
    {0x0C, 0x10, (int)FAILURE,       "Incomplete Multiple Atomic Write Operations"},
    {0x0C, 0x11, (int)FAILURE,       "Write Error - Recovery Scan Needed"},
    {0x0C, 0x12, (int)FAILURE,       "Write Error - Insufficient Zone Resources"},
    {0x0D, 0x00, (int)FAILURE,       "Error Detected By Third Party Temporary Initiator"},
    {0x0D, 0x01, (int)FAILURE,       "Third Party Device Failure"},
    {0x0D, 0x02, (int)FAILURE,       "Copy Target Device Not Reachable"},
    {0x0D, 0x03, (int)FAILURE,       "Incorrect Copy Target Device Type"},
    {0x0D, 0x04, (int)FAILURE,       "Copy Target Device Data Underrun"},
    {0x0D, 0x05, (int)FAILURE,       "Copy Target Device Data Overrun"},
    {0x0E, 0x00, (int)FAILURE,       "Invalid Information Unit"},
    {0x0E, 0x01, (int)FAILURE,       "Information Unit Too Short"},
    {0x0E, 0x02, (int)FAILURE,       "Information Unit Too Long"},
    {0x0E, 0x03, (int)FAILURE,       "Invalid Field In Command Information Unit"},
    {0x10, 0x00, (int)FAILURE,       "ID CRC Or ECC Error"},
    {0x10, 0x01, (int)FAILURE,       "Logical Block Guard Check Failed"},
    {0x10, 0x02, (int)FAILURE,       "Logical Block Application Tag Check Failed"},
    {0x10, 0x03, (int)FAILURE,       "Logical Block Reference Tag Check Failed"},
    {0x10, 0x04, (int)FAILURE,       "Logical Block Protection Error On Recover Buffered Data"},
    {0x10, 0x05, (int)FAILURE,       "Logical Block Protection Method Error"},
    {0x11, 0x00, (int)FAILURE,       "Unrecovered Read Error"},
    {0x11, 0x01, (int)FAILURE,       "Read Retries Exhausted"},
    {0x11, 0x02, (int)FAILURE,       "Error Too Long To Correct"},
    {0x11, 0x03, (int)FAILURE,       "Multiple Read Errors"},
    {0x11, 0x04, (int)FAILURE,       "Unrecovered Read Error - Auto Reallocate Failed"},
    {0x11, 0x05, (int)FAILURE,       "L-EC Uncorrectable Error"},
    {0x11, 0x06, (int)FAILURE,       "CIRC Unrecovered Error"},
    {0x11, 0x07, (int)FAILURE,       "Data Re-synchonization Error"},
    {0x11, 0x08, (int)FAILURE,       "Incomplete Block Read"},
    {0x11, 0x09, (int)FAILURE,       "No Gap Found"},
    {0x11, 0x0A, (int)FAILURE,       "Miscorrected Error"},
    {0x11, 0x0B, (int)FAILURE,       "Unrecovered Read Error - Recommend Reassignment"},
    {0x11, 0x0C, (int)FAILURE,       "Unrecovered Read Error - Recommend Rewrite The Data"},
    {0x11, 0x0D, (int)FAILURE,       "De-compression CRC Error"},
    {0x11, 0x0E, (int)FAILURE,       "Cannot Decompress Using Declared Algorithm"},
    {0x11, 0x0F, (int)FAILURE,       "Error Reading UPC/EAN Number"},
    {0x11, 0x10, (int)FAILURE,       "Error Reading ISRC Number"},
    {0x11, 0x11, (int)FAILURE,       "Read Error - Loss Of Streaming"},
    {0x11, 0x12, (int)FAILURE,       "Auxiliary Memory Read Error"},
    {0x11, 0x13, (int)FAILURE,       "Read Error - Failed Retransmission Request"},
    {0x11, 0x14, (int)FAILURE,       "Read Error - LBA Marked Bad By Application Client"},
    {0x11, 0x15, (int)FAILURE,       "Write After Sanitize Required"},
    {0x12, 0x00, (int)FAILURE,       "Address Mark Not Found for ID Field"},
    {0x13, 0x00, (int)FAILURE,       "Address Mark Not Found for Data Field"},
    {0x14, 0x00, (int)FAILURE,       "Recorded Entity Not Found"},
    {0x14, 0x01, (int)FAILURE,       "Record Not Found"},
    {0x14, 0x02, (int)FAILURE,       "Filemark Or Setmark Not Found"},
    {0x14, 0x03, (int)FAILURE,       "End-Of-Data Not Found"},
    {0x14, 0x04, (int)FAILURE,       "Block Sequence Error"},
    {0x14, 0x05, (int)FAILURE,       "Record Not Found - Recommend Reassignment"},
    {0x14, 0x06, (int)FAILURE,       "Record Not Found - Data Auto-Reallocated"},
    {0x14, 0x07, (int)FAILURE,       "Locate Operation Failure"},
    {0x15, 0x00, (int)FAILURE,       "Random Positioning Error"},
    {0x15, 0x01, (int)FAILURE,       "Mechanical Positioning Error"},
    {0x15, 0x02, (int)FAILURE,       "Positioning Error Detected By Read Of Medium"},
    {0x16, 0x00, (int)FAILURE,       "Data Synchronization Mark Error"},
    {0x16, 0x01, (int)SUCCESS,       "Data Sync Error - Data Rewritten"},
    {0x16, 0x02, (int)FAILURE,       "Data Sync Error - Recommend Rewrite"},
    {0x16, 0x03, (int)SUCCESS,       "Data Sync Error - Data Auto-Reallocation"},
    {0x16, 0x04, (int)FAILURE,       "Data Sync Error - Recommend Reassignment"},
    ...
    {0x18, 0x08, (int)FAILURE,       "Recovered Data With Linking"},
    {0x19, 0x00, (int)FAILURE,       "Defect List Error"},
    {0x19, 0x01, (int)FAILURE,       "Defect List Not Available"},
    {0x19, 0x02, (int)FAILURE,       "Defect List Error In Primary List"},
    {0x19, 0x03, (int)FAILURE,       "Defect List Error In Grown List"},
    {0x1A, 0x00, (int)FAILURE,       "Parameter List Length Error"},
    {0x1B, 0x00, (int)FAILURE,       "Synchronous Data Transfer Error"},
    {0x1C, 0x00, (int)FAILURE,       "Defect List Not Found"},
    {0x1C, 0x01, (int)FAILURE,       "Primary Defect List Not Found"},
    {0x1C, 0x02, (int)FAILURE,       "Grown Defect List Not Found"},
    {0x1D, 0x00, (int)FAILURE,       "Miscompare During Verify Operation"},
    {0x1D, 0x01, (int)FAILURE,       "Miscompare During Verify Of Unmapped LBA"},
    {0x1E, 0x00, -1,                 "Recovered ID With ECC Correction"},
    {0x1F, 0x00, (int)FAILURE,       "Partial Defect List Transfer"},
    {0x20, 0x00, (int)NOT_SUPPORTED, "Invalid Command Operation Code"},
    {0x20, 0x01, (int)FAILURE,       "Access Denied - Initiator Pending - Enrolled"},
    {0x20, 0x02, (int)FAILURE,       "Access Denied - No Access Rights"},
    {0x20, 0x03, (int)FAILURE,       "Access Denied - Invalid Management ID Key"},
    {0x20, 0x04, (int)FAILURE,       "Illegal Command While In Write Capable State"},
    {0x20, 0x05, (int)FAILURE,       "Illegal Command While In Read Capable State"},
    {0x20, 0x06, (int)FAILURE,       "Illegal Command While In Explicit Address Mode"},
    {0x20, 0x07, (int)FAILURE,       "Illegal Command While In Implicit Address Mode"},
    {0x20, 0x08, (int)FAILURE,       "Access Denied - Enrollment Conflict"},
    {0x20, 0x09, (int)FAILURE,       "Access Denied - Invalid Logical Unit Identifier"},
    {0x20, 0x0A, (int)FAILURE,       "Access Denied - Invalid Proxy Token"},
    {0x20, 0x0B, (int)FAILURE,       "Access Denied - ACL LUN Conflict"},
    {0x20, 0x0C, (int)FAILURE,       "Illegal Command When Not In Append-Only Mode"},
    {0x20, 0x0D, (int)FAILURE,       "Not An Administrative Logical Unit"},
    {0x20, 0x0E, (int)FAILURE,       "Not A Subsidiary Logical Unit"},
    {0x20, 0x0F, (int)FAILURE,       "Not A Conglomerate Logical Unit"},
    {0x21, 0x00, (int)FAILURE,       "Logical Block Address Out Of Range"},
    {0x21, 0x01, (int)FAILURE,       "Invalid Element Address"},
    {0x21, 0x02, (int)FAILURE,       "Invalid Address For Write"},
    {0x21, 0x03, (int)FAILURE,       "Invalid Write Crossing Layer Jump"},
    {0x21, 0x04, (int)FAILURE,       "Unaligned Write Command"},
    {0x21, 0x05, (int)FAILURE,       "Write Boundary Violation"},
    {0x21, 0x06, (int)FAILURE,       "Attempt To Read Invalid Data"},
    {0x21, 0x07, (int)FAILURE,       "Read Boundary Violation"},
    {0x21, 0x08, (int)FAILURE,       "Misaligned Write Command"},
    {0x22, 0x00, (int)NOT_SUPPORTED, "Illegal Function. Use 22 00, 24 00, or 26 00"},
    {0x23, 0x00, (int)FAILURE,       "Invalid Token Operation - Cause Not Reportable"},
    {0x23, 0x01, (int)FAILURE,       "Invalid Token Operation - Unsupported Token Type"},
    {0x23, 0x02, (int)NOT_SUPPORTED, "Invalid Token Operation - Remote Token Usage Not Supported"},
    {0x23, 0x03, (int)NOT_SUPPORTED, "Invalid Token Operation - Remote ROD Token Creation Not Supported"},
    {0x23, 0x04, (int)FAILURE,       "Invalid Token Operation - Token Unknown"},
    {0x23, 0x05, (int)FAILURE,       "Invalid Token Operation - Token Corrupt"},
    {0x23, 0x06, (int)FAILURE,       "Invalid Token Operation - Token Revoked"},
    {0x23, 0x07, (int)FAILURE,       "Invalid Token Operation - Token Expired"},
    {0x23, 0x08, (int)FAILURE,       "Invalid Token Operation - Token Cancelled"},
    {0x23, 0x09, (int)FAILURE,       "Invalid Token Operation - Token Deleted"},
    {0x23, 0x0A, (int)FAILURE,       "Invalid Token Operation - Invalid Token Length"},
    {0x24, 0x00, (int)NOT_SUPPORTED, "Invalid Field In CDB"},
    {0x24, 0x01, (int)FAILURE,       "CDB Decryption Error"},
    {0x24, 0x02, (int)FAILURE,       "Invalid CDB Field While In Explicit Block Address Model"},
    {0x24, 0x03, (int)FAILURE,       "Invalid CDB Field While In Implicit Block Address Model"},
    {0x24, 0x04, (int)FAILURE,       "Security Audit Value Frozen"},
    {0x24, 0x05, (int)FAILURE,       "Security Working Key Frozen"},
    {0x24, 0x06, (int)FAILURE,       "Nonce Not Unique"},
    {0x24, 0x07, (int)FAILURE,       "Nonce Timestamp Out Of Range"},
    {0x24, 0x08, (int)FAILURE,       "Invalid XCDB"},
    {0x24, 0x09, (int)FAILURE,       "Invalid Fast Format"},
    {0x25, 0x00, (int)NOT_SUPPORTED, "Logical Unit Not Supported"},
    {0x26, 0x00, (int)FAILURE,       "Invalid Field In Parameter List"},
    {0x26, 0x01, (int)NOT_SUPPORTED, "Parameter Not Supported"},
    {0x26, 0x02, (int)FAILURE,       "Parameter Value Invalid"},
    {0x26, 0x03, (int)NOT_SUPPORTED, "Threshold Parameters Not Supported"},
    {0x26, 0x04, (int)FAILURE,       "Invalid Release Of Persistent Reservation"},
    {0x26, 0x05, (int)FAILURE,       "Data Decryption Error"},
    {0x26, 0x06, (int)FAILURE,       "Too Many Target Descriptors"},
    {0x26, 0x07, (int)NOT_SUPPORTED, "Unsupported Target Descriptor Type Code"},
    {0x26, 0x08, (int)FAILURE,       "Too Many Segment Descriptors"},
    {0x26, 0x09, (int)FAILURE,       "Unsupported Segment Descriptor Type Code"},
    {0x26, 0x0A, (int)FAILURE,       "Unexpected Inexact Segment"},
    {0x26, 0x0B, (int)FAILURE,       "Inline Data Length Exceeded"},
    {0x26, 0x0C, (int)FAILURE,       "Invalid Operation For Copy Source Or Destination"},
    {0x26, 0x0D, (int)FAILURE,       "Copy Segment Granularity Violation"},
    {0x26, 0x0E, (int)FAILURE,       "Invalid Parameter While Port Is Enabled"},
    {0x26, 0x0F, (int)FAILURE,       "Invalid Data-Out Buffer Integrity Check Value"},
    {0x26, 0x10, (int)FAILURE,       "Data Decryption Key Fail Limit Reached"},
    {0x26, 0x11, (int)FAILURE,       "Incomplete Key-Associated Data Set"},
    {0x26, 0x12, (int)FAILURE,       "Vendor Specific Key Reference Not Found"},
    {0x26, 0x13, (int)FAILURE,       "Application Tag Mode Page Is Invalid"},
    {0x26, 0x14, (int)FAILURE,       "Tape Stream Mirroring Prevented"},
    {0x26, 0x15, (int)FAILURE,       "Copy Source Or Copy Destination Not Authorized"},
    {0x27, 0x00, (int)FAILURE,       "Write Protected"},
    {0x27, 0x01, (int)FAILURE,       "Hardware Write Protected"},
    {0x27, 0x02, (int)FAILURE,       "Logical Unit Software Write Protected"},
    {0x27, 0x03, (int)FAILURE,       "Associated Write Protect"},
    {0x27, 0x04, (int)FAILURE,       "Persistent Write Protect"},
    {0x27, 0x05, (int)FAILURE,       "Permanent Write Protect"},
    {0x27, 0x06, (int)FAILURE,       "Conditional Write Protect"},
    {0x27, 0x07, (int)FAILURE,       "Space Allocation Failed Write Protect"},
    {0x27, 0x08, (int)FAILURE,       "Zone Is Read Only"},
    {0x28, 0x00, (int)FAILURE,       "Not Ready To Ready Change, Medium May Have Changed"},
    {0x28, 0x01, (int)SUCCESS,       "Import or Export Element Accessed"},
    {0x28, 0x02, (int)FAILURE,       "Format-Layer May Have Changed"},
    {0x28, 0x03, (int)FAILURE,       "Import/Export Element Accessed, Medium Changed"},
    ...
    {0x29, 0x07, (int)FAILURE,       "I_T Nexus Loss Occurred"},
    {0x2A, 0x00, (int)SUCCESS,       "Parameters Changed"},
    {0x2A, 0x01, (int)SUCCESS,       "Mode Parameters Changed"},
    {0x2A, 0x02, (int)SUCCESS,       "Log Parameters Changed"},
    {0x2A, 0x03, (int)SUCCESS,       "Reservations Preempted"},
    {0x2A, 0x04, (int)SUCCESS,       "Reservations Released"},
    {0x2A, 0x05, (int)SUCCESS,       "Registrations Preempted"},
    {0x2A, 0x06, (int)FAILURE,       "Asymmetric Access State Changed"},
    {0x2A, 0x07, (int)FAILURE,       "Implicit Asymetric Access State Transition Failed"},
    {0x2A, 0x08, (int)SUCCESS,       "Priority Changed"},
    {0x2A, 0x09, (int)SUCCESS,       "Capacity Data Has Changed"},
    {0x2A, 0x0A, (int)SUCCESS,       "Error History I_T Nexus Cleared"},
    {0x2A, 0x0B, (int)SUCCESS,       "Error History Snapshot Released"},
    {0x2A, 0x0C, (int)SUCCESS,       "Error Recovery Attributes Have Changed"},
    {0x2A, 0x0D, (int)SUCCESS,       "Data Encryption Capabilities Changed"},
    {0x2A, 0x10, (int)SUCCESS,       "Timestamp Changed"},
    ...
    {0x2A, 0x14, (int)SUCCESS,       "SA Creation Capabilities Has Changed"},
    {0x2A, 0x15, (int)FAILURE,       "Medium Removal Precention Preempted"},
    {0x2A, 0x16, -1,                 "Zone Reset Write Pointer Recommended"},
    {0x2B, 0x00, (int)FAILURE,       "Copy Cannot Execute Since Host Cannot Disconnect"},
    {0x2C, 0x00, (int)FAILURE,       "Command Sequence Error"},
    {0x2C, 0x01, (int)FAILURE,       "Too Many Windows Specified"},
    {0x2C, 0x02, (int)FAILURE,       "Invalid Combination Of Windows Specified"},
    {0x2C, 0x03, (int)FAILURE,       "Current Program Area Is Not Empty"},
    {0x2C, 0x04, -1,                 "Current Program Area Is Empty"},
    {0x2C, 0x05, (int)FAILURE,       "Illegal Power Condition Request"},
    {0x2C, 0x06, (int)FAILURE,       "Persistent Prevent Conflict"},
    {0x2C, 0x07, (int)FAILURE,       "Previous Busy Status"},
    {0x2C, 0x08, (int)FAILURE,       "Previous Task Set Full Status"},
    {0x2C, 0x09, (int)FAILURE,       "Previous Reservation Conflict Status"},
    {0x2C, 0x0A, -1,                 "Partition Or Collection Contains User Objects"},
    {0x2C, 0x0B, -1,                 "Not Reserved"},
    {0x2C, 0x0C, (int)FAILURE,       "ORWrite Generation Does Not Match"},
    {0x2C, 0x0D, (int)FAILURE,       "Reset Write Pointer Not Allowed"},
    {0x2C, 0x0E, (int)FAILURE,       "Zone Is Offline"},
    {0x2C, 0x0F, (int)FAILURE,       "Stream Not Open"},
    {0x2C, 0x10, -1,                 "Unwritten Data In Zone"},
    {0x2C, 0x11, (int)FAILURE,       "Descriptor Format Sense Data Required"},
    {0x2D, 0x00, -1,                 "Overwrite Error On Update In Place"},
    {0x2E, 0x00, (int)FAILURE,       "Insufficient Time For Operation"},
    {0x2E, 0x01, (int)FAILURE,       "Command Timeout Before Processing"},
    {0x2E, 0x02, (int)FAILURE,       "Command Timeout During Processing"},
    {0x2E, 0x03, (int)FAILURE,       "Command Timeout During Processing Due To Error Recovery"},
    {0x2F, 0x00, (int)FAILURE,       "Commands Cleared By Another Initiator"},
    {0x2F, 0x01, (int)FAILURE,       "Commands Cleared By Power Loss Notification"},
    {0x2F, 0x02, (int)FAILURE,       "Commands Cleared By Device Server"},
    {0x2F, 0x03, (int)FAILURE,       "Some Commands Cleared By Queuing Layer Event"},
    // {0x2F, 0x07, (int)FAILURE,    "Space Allocation Failed Write Protect"},
    {0x30, 0x00, (int)FAILURE,       "Incompatible Medium Installed"},
    {0x30, 0x01, (int)FAILURE,       "Cannot Read Medium - Unknown Format"},
    {0x30, 0x02, (int)FAILURE,       "Cannot Read Medium - Incompatible Format"},
    {0x30, 0x03, (int)UNKNOWN,       "Cleaning Cartridge Installed"},
    {0x30, 0x04, (int)FAILURE,       "Cannot Write Medium - Unknown Format"},
    {0x30, 0x05, (int)FAILURE,       "Cannot Write Medium - Incompatible Format"},
    {0x30, 0x06, (int)FAILURE,       "Cannot Format Medium - Incompatible Medium"},
    {0x30, 0x07, (int)FAILURE,       "Cleaning Failure"},
    {0x30, 0x08, (int)FAILURE,       "Cannot Write - Application Code Mismatch"},
    {0x30, 0x09, (int)FAILURE,       "Current Session Not Fixated For Append"},
    {0x30, 0x0A, (int)FAILURE,       "Cleaning Request Rejected"},
    {0x30, 0x0C, (int)FAILURE,       "WORM Medium - Overwrite Attempted"},
    {0x30, 0x0D, (int)FAILURE,       "WORM Medium - Integrity Check"},
    {0x30, 0x10, (int)FAILURE,       "Medium Not Formatted"},
    {0x30, 0x11, (int)FAILURE,       "Incompatible Volume Type"},
    {0x30, 0x12, (int)FAILURE,       "Incompatible Volume Qualifier"},
    {0x30, 0x13, (int)FAILURE,       "Cleaning Volume Expired"},
    {0x31, 0x00, (int)FAILURE,       "Medium Format Corrupted"},
    {0x31, 0x01, (int)FAILURE,       "Format Command Failed"},
    {0x31, 0x02, (int)FAILURE,       "Zoned Formatting Failed Due To Spare Linking"},
    {0x31, 0x03, (int)FAILURE,       "Sanitize Command Failed"},
    {0x32, 0x00, (int)FAILURE,       "No Defect Space Location Available"},
    {0x32, 0x01, (int)FAILURE,       "Defect List Update Failure"},
    {0x33, 0x00, (int)FAILURE,       "Tape Length Error"},
    {0x34, 0x00, (int)FAILURE,       "Enclosure Failure"},
    {0x35, 0x00, (int)FAILURE,       "Enclosure Services Failure"},
    {0x35, 0x01, (int)NOT_SUPPORTED, "Unsupported Enclosure Function"},
    {0x35, 0x02, (int)NOT_SUPPORTED, "Enclosure Services Unavailable"},
    {0x35, 0x03, (int)FAILURE,       "Enclosure Services Transfer Failure"},
    {0x35, 0x04, (int)FAILURE,       "Enclosure Services Transfer Refused"},
    {0x35, 0x05, (int)FAILURE,       "Enclosure Services Checksum Failure"},
    {0x36, 0x00, (int)FAILURE,       "Ribbon, Ink, Or Toner Failure"},
    ...
    {0x38, 0x07, (int)FAILURE,       "Thin Provisioning Soft Threshold Reached"},
    {0x39, 0x00, (int)NOT_SUPPORTED, "Saving Parameters Not Supported"},
    {0x3A, 0x00, (int)FAILURE,       "Medium Not Present"},
    {0x3A, 0x01, (int)FAILURE,       "Medium Not Present - Tray Closed"},
    {0x3A, 0x02, (int)FAILURE,       "Medium Not Present - Tray Open"},
    {0x3A, 0x03, (int)FAILURE,       "Medium Not Present - Loadable"},
    {0x3A, 0x04, (int)FAILURE,       "Medium Not Present - Medium Auxilary Memory Accessible"},
    {0x3B, 0x00, (int)FAILURE,       "Sequential Positioning Error"},
    {0x3B, 0x01, (int)FAILURE,       "Tape Position Error At Beginning-Of-Medium"},
    {0x3B, 0x02, (int)FAILURE,       "Tape Position Error At End-Of-Medium"},
    {0x3B, 0x03, (int)FAILURE,       "Tape Or Electronic Vertical Forms Unit Not Ready"},
    {0x3B, 0x04, (int)FAILURE,       "Slew Failure"},
    {0x3B, 0x05, (int)FAILURE,       "Paper Jam"},
    {0x3B, 0x06, (int)FAILURE,       "Failed To Sense Top-Of-Form"},
    {0x3B, 0x07, (int)FAILURE,       "Failed To Sense Bottom-Of-Form"},
    {0x3B, 0x08, (int)FAILURE,       "Reposition Error"},
    {0x3B, 0x09, (int)FAILURE,       "Read Past End Of Medium"},
    {0x3B, 0x0A, (int)FAILURE,       "Read Past Beginning Of Medium"},
    {0x3B, 0x0B, (int)FAILURE,       "Position Past End Of Medium"},
    {0x3B, 0x0C, (int)FAILURE,       "Position Past Beginning Of Medium"},
    {0x3B, 0x0D, (int)FAILURE,       "Medium Destination Element Full"},
    {0x3B, 0x0E, (int)FAILURE,       "Medium Source Element Empty"},
    ...
    {0x3B, 0x16, (int)FAILURE,       "Mechanical Positioning Or Changer Error"},
    {0x3B, 0x17, (int)FAILURE,       "Read Past End Of User Object"},
    ...
    {0x3B, 0x1C, (int)FAILURE,       "Too Many Logical Objects On Partition To Supported Operation"},
    {0x3D, 0x00, (int)FAILURE,       "Invalid Bits In Identify Message"},
    {0x3E, 0x00, (int)FAILURE,       "Logical Unit Has Not Self-Configured Yet"},
    {0x3E, 0x01, (int)FAILURE,       "Logical Unit Failure"},
    {0x3E, 0x02, (int)FAILURE,       "Timeout On Logical Unit"},
    {0x3E, 0x03, (int)FAILURE,       "Logical Unit Failed Self-Test"},
    {0x3E, 0x04, (int)FAILURE,       "Logical Unit Unable to Update Self-Test Log"},
    {0x3F, 0x00, (int)SUCCESS,       "Target Operating Conditions Have Changed"},
    {0x3F, 0x01, (int)SUCCESS,       "Microcode Has Been Changed"},
    {0x3F, 0x02, (int)SUCCESS,       "Changed Operation Definition"},
    {0x3F, 0x03, (int)SUCCESS,       "Inquiry Data Has Changed"},
    {0x3F, 0x04, (int)SUCCESS,       "Component Device Attached"},
    {0x3F, 0x05, (int)SUCCESS,       "Device Identifier Changed"},
    {0x3F, 0x06, (int)SUCCESS,       "Redundancy Group Created Or Modified"},
    {0x3F, 0x07, (int)SUCCESS,       "Redundancy Group Deleted"},
    {0x3F, 0x08, (int)SUCCESS,       "Spare Created Or Modified"},
    {0x3F, 0x09, (int)SUCCESS,       "Spare Deleted"},
    {0x3F, 0x0A, (int)SUCCESS,       "Volume Set Created Or Modified"},
    {0x3F, 0x0B, (int)SUCCESS,       "Volume Set Deleted"},
    {0x3F, 0x0C, (int)SUCCESS,       "Volume Set Deassigned"},
    {0x3F, 0x0D, (int)SUCCESS,       "Volume Set Reassigned"},
    {0x3F, 0x0E, (int)SUCCESS,       "Reported LUNs Data Has Changed"},
    {0x3F, 0x0F, (int)SUCCESS,       "Echo Buffer Overwritten"},
    {0x3F, 0x10, (int)SUCCESS,       "Medium Loadable"},
    {0x3F, 0x11, (int)SUCCESS,       "Medium Auxilary Memory Accessible"},
    {0x3F, 0x12, (int)SUCCESS,       "iSCSI IP Address Added"},
    {0x3F, 0x13, (int)SUCCESS,       "iSCSI IP Address Removed"},
    {0x3F, 0x14, (int)SUCCESS,       "iSCSI IP Address Changed"},
    {0x3F, 0x15, (int)SUCCESS,       "Inspect Referrals Sense Descriptors"},
    {0x3F, 0x16, (int)SUCCESS,       "Microcode Has Been Changed Without Reset"},
    {0x3F, 0x17, (int)SUCCESS,       "Zone Transition To Full"},
    {0x3F, 0x18, -1,                 "Bind Completed"},
    {0x3F, 0x19, -1,                 "Bind Redirected"},
    {0x3F, 0x1A, -1,                 "Subsidiary Binding Changed"},
    {0x41, 0x00, (int)FAILURE,       "Data Path Failure (Should Use 40NN)"},
    {0x42, 0x00, (int)FAILURE,       "Power-on Or Self-Test Failure (Should use 40 NN)"},
    {0x43, 0x00, (int)FAILURE,       "Message Error"},
    {0x44, 0x00, (int)FAILURE,       "Internal Target Failure"},
    {0x44, 0x01, (int)FAILURE,       "Persistent Reservation Information Lost"},
    {0x44, 0x71, (int)FAILURE,       "ATA Device Failed Set Features"},
    {0x45, 0x00, (int)FAILURE,       "Select Or Reselect Failure"},
    {0x46, 0x00, (int)FAILURE,       "Unsuccessful Soft Reset"},
    {0x47, 0x00, (int)FAILURE,       "SCSI Parity Error"},
    {0x47, 0x01, (int)FAILURE,       "Data Phase CRC Error Detected"},
    {0x47, 0x02, (int)FAILURE,       "SCSI Parity Error Detected During ST Data Phase"},
    {0x47, 0x03, (int)FAILURE,       "Information Unit uiCRC Error Detected"},
    {0x47, 0x04, (int)FAILURE,       "Asynchronous Information Protection Error Detected"},
    {0x47, 0x05, (int)FAILURE,       "Protocol Service CRC Error"},
    {0x47, 0x06, (int)IN_PROGRESS,   "PHY Test Function In Progress"},
    {0x47, 0x7F, (int)FAILURE,       "Some Commands Cleared By ISCSI Protocol Event"},
    {0x48, 0x00, (int)SUCCESS,       "Initiator Detected Error Message Received"},
    {0x49, 0x00, (int)FAILURE,       "Invalid Message Error"},
    {0x4A, 0x00, (int)FAILURE,       "Command Phase Error"},
    {0x4B, 0x00, (int)FAILURE,       "Data Phase Error"},
    {0x4B, 0x01, (int)FAILURE,       "Invalid Target Port Transfer Tag Received"},
    {0x4B, 0x02, (int)FAILURE,       "Too Much Write Data"},
    {0x4B, 0x03, (int)FAILURE,       "ACK/NAK Timeout"},
    {0x4B, 0x04, (int)SUCCESS,       "NAK Received"},
    {0x4B, 0x05, (int)FAILURE,       "Data Offset Error"},
    {0x4B, 0x06, (int)FAILURE,       "Initiator Response Timeout"},
    {0x4B, 0x07, (int)FAILURE,       "Connection Lost"},
    {0x4B, 0x08, (int)FAILURE,       "Data-In Buffer Overflow - Data Buffer Size"},
    {0x4B, 0x09, (int)FAILURE,       "Data-In Buffer Overflow - Data Buffer Descriptor Area"},
    {0x4B, 0x0A, (int)FAILURE,       "Data-In Buffer Error"},
    {0x4B, 0x0B, (int)FAILURE,       "Data-Out Buffer Overflow - Data Buffer Size"},
    {0x4B, 0x0C, (int)FAILURE,       "Data-Out Buffer Overflow - Data Buffer Descriptor Area"},
    {0x4B, 0x0D, (int)FAILURE,       "Data-Out Buffer Error"},
    {0x4B, 0x0E, (int)FAILURE,       "PCIE Fabric Error"},
    {0x4B, 0x0F, (int)FAILURE,       "PCIE Completion Timeout"},
    {0x4B, 0x10, (int)FAILURE,       "PCIE Completer Abort"},
    {0x4B, 0x11, (int)FAILURE,       "PCIE Poisoned TLP Received"},
    {0x4B, 0x12, (int)FAILURE,       "PCIE ECRC Check Failed"},
    {0x4B, 0x13, (int)NOT_SUPPORTED, "PCIE Unsupported Request"},
    {0x4B, 0x14, (int)FAILURE,       "PCIE ACS Violation"},
    {0x4B, 0x15, (int)FAILURE,       "PCIE TLP Prefix Blocked"},
    {0x4C, 0x00, (int)FAILURE,       "Logical Unit Failed Self-Configuration"},
    {0x4E, 0x00, (int)FAILURE,       "Overlapped Commands Attempted"},
    {0x50, 0x00, (int)FAILURE,       "Write Append Error"},
    {0x50, 0x01, (int)FAILURE,       "Write Append Position Error"},
    {0x50, 0x02, (int)FAILURE,       "Position Error Related To Timing"},
    {0x51, 0x00, (int)FAILURE,       "Erase Failure"},
    {0x51, 0x01, (int)FAILURE,       "Erase Failure - Incomplete Erase Operation Detected"},
    {0x52, 0x00, (int)FAILURE,       "Cartridge Fault"},
    {0x53, 0x00, (int)FAILURE,       "Media Load Or Eject Failed"},
    {0x53, 0x01, (int)FAILURE,       "Unload Tape Failure"},
    {0x53, 0x02, (int)FAILURE,       "Medium Removal Prevented"},
    {0x53, 0x03, (int)FAILURE,       "Medium Removal Prevented By Data Transfer Element"},
    {0x53, 0x04, (int)FAILURE,       "Medium Thread Or Unthread Failure"},
    {0x53, 0x05, (int)FAILURE,       "Volume Identifier Invalid"},
    {0x53, 0x06, (int)FAILURE,       "Volume Identifier Missing"},
    {0x53, 0x07, (int)FAILURE,       "Duplicate Volume Identifier"},
    {0x53, 0x08, (int)FAILURE,       "Element Status Unknown"},
    {0x53, 0x09, (int)FAILURE,       "Data Transfer Device Error - Load Failed"},
    {0x53, 0x0A, (int)FAILURE,       "Data Transfer Device Error - Unload Failed"},
    {0x53, 0x0B, (int)FAILURE,       "Data Transfer Device Error - Unload Missing"},
    {0x53, 0x0C, (int)FAILURE,       "Data Transfer Device Error - Eject Failed"},
    {0x53, 0x0D, (int)FAILURE,       "Data Transfer Device Error - Library Communication Failed"},
    {0x54, 0x00, (int)FAILURE,       "SCSI To host System Interface Failure"},
    {0x55, 0x00, (int)FAILURE,       "System Resource Failure"},
    {0x55, 0x01, (int)FAILURE,       "System Buffer Full"},
    {0x55, 0x02, (int)FAILURE,       "Insufficient Reservation Resources"},
    {0x55, 0x03, (int)FAILURE,       "Insufficient Resources"},
    {0x55, 0x04, (int)FAILURE,       "Insufficient Registration Resources"},
    {0x55, 0x05, (int)FAILURE,       "Insufficient Access Control Resources"},
    {0x55, 0x06, (int)FAILURE,       "Auxiliary Memory Out Of Space"},
    {0x55, 0x07, (int)FAILURE,       "Quota Error"},
    {0x55, 0x08, (int)FAILURE,       "Maximum Number Of Supplemental Decryption Keys Exceeded"},
    {0x55, 0x09, (int)FAILURE,       "Medium Auxilary Memory Not Accessible"},
    {0x55, 0x0A, (int)FAILURE,       "Data Currently Unavailable"},
    {0x55, 0x0B, (int)FAILURE,       "Insufficient Power For Operation"},
    {0x55, 0x0C, (int)FAILURE,       "Insufficient Resources To Create ROD"},
    {0x55, 0x0D, (int)FAILURE,       "Insufficient Resources To Create ROD Token"},
    {0x55, 0x0E, (int)FAILURE,       "Insufficient Zone Resources"},
    ...
    {0x57, 0x00, (int)FAILURE,       "Unable To Recover Table-Of-Contents"},
    {0x58, 0x00, (int)FAILURE,       "Generation Does Not Exist"},
    {0x59, 0x00, -1,                 "Updated Block Read"},
    {0x5A, 0x00, (int)FAILURE,       "Operator Request Or State Change Input"},
    {0x5A, 0x01, (int)FAILURE,       "Operator Medium Removal Request"},
    {0x5A, 0x02, (int)FAILURE,       "Operator Selected Write Protect"},
    {0x5A, 0x03, (int)FAILURE,       "Operator Selected Write Permit"},
    {0x5B, 0x00, (int)FAILURE,       "Log Exception"},
    {0x5B, 0x01, (int)FAILURE,       "Threshold Condition Met"},
    {0x5B, 0x02, (int)FAILURE,       "Log Counter At Maximum"},
    {0x5B, 0x03, (int)FAILURE,       "Log List Codes Exhausted"},
    {0x5C, 0x00, -1,                 "RPL Status Change"},
    {0x5C, 0x01, (int)SUCCESS,       "Spindles Synchronized"},
    {0x5C, 0x02, (int)FAILURE,       "Spindles Not Synchronized"},
    {0x5D, 0x00, (int)FAILURE,       "Failure Prediction Threshold Exceeded"},
    {0x5D, 0x01, (int)FAILURE,       "Media Failure Prediction Threshold Exceeded"},
    {0x5D, 0x02, (int)FAILURE,       "Logical Unit Failure Prediction Threshold Exceeded"},
    {0x5D, 0x03, (int)FAILURE,       "Spare Area Exhaustion Prediction Threshold Exceeded"},
    {0x5D, 0x10, (int)FAILURE,       "Hardware Impending Failure - General Hard Drive Failure"},
    {0x5D, 0x11, (int)FAILURE,       "Hardware Impending Failure - Drive Error Rate Too High"},
    {0x5D, 0x12, (int)FAILURE,       "Hardware Impending Failure - Data Error Rate Too High"},
    {0x5D, 0x13, (int)FAILURE,       "Hardware Impending Failure - Seek Error Rate Too High"},
    {0x5D, 0x14, (int)FAILURE,       "Hardware Impending Failure - Too Many Block Reassigns"},
    {0x5D, 0x15, (int)FAILURE,       "Hardware Impending Failure - Access Times Too High"},
    {0x5D, 0x16, (int)FAILURE,       "Hardware Impending Failure - Start Unit Times Too High"},
    {0x5D, 0x17, (int)FAILURE,       "Hardware Impending Failure - Channel Parametrics"},
    {0x5D, 0x18, (int)FAILURE,       "Hardware Impending Failure - Controller Detected"},
    {0x5D, 0x19, (int)FAILURE,       "Hardware Impending Failure - Throughput Performance"},
    {0x5D, 0x1A, (int)FAILURE,       "Hardware Impending Failure - Seek Time Performance"},
    {0x5D, 0x1B, (int)FAILURE,       "Hardware Impending Failure - Spin-Up Retry Count"},
    {0x5D, 0x1C, (int)FAILURE,       "Hardware Impending Failure - Drive Calibration Retry Count"},
    {0x5D, 0x1D, (int)FAILURE,       "Hardware Impending Failure - Power Loss Protection Circuit"},
    {0x5D, 0x20, (int)FAILURE,       "Controller Impending Failure - General Hard Drive Failure"},
    {0x5D, 0x21, (int)FAILURE,       "Controller Impending Failure - Drive Error Rate Too High"},
    {0x5D, 0x22, (int)FAILURE,       "Controller Impending Failure - Data Error Rate Too High"},
    {0x5D, 0x23, (int)FAILURE,       "Controller Impending Failure - Seek Error Rate Too High"},
    {0x5D, 0x24, (int)FAILURE,       "Controller Impending Failure - Too Many Block Reassigns"},
    {0x5D, 0x25, (int)FAILURE,       "Controller Impending Failure - Access Times Too High"},
    {0x5D, 0x26, (int)FAILURE,       "Controller Impending Failure - Start Unit Times Too High"},
    {0x5D, 0x27, (int)FAILURE,       "Controller Impending Failure - Channel Parametrics"},
    {0x5D, 0x28, (int)FAILURE,       "Controller Impending Failure - Controller Detected"},
    {0x5D, 0x29, (int)FAILURE,       "Controller Impending Failure - Throughput Performance"},
    {0x5D, 0x2A, (int)FAILURE,       "Controller Impending Failure - Seek Time Performance"},
    {0x5D, 0x2B, (int)FAILURE,       "Controller Impending Failure - Spin-Up Retry Count"},
    {0x5D, 0x2C, (int)FAILURE,       "Controller Impending Failure - Drive Calibration Retry Count"},
    {0x5D, 0x30, (int)FAILURE,       "Data Channel Impending Failure - General Hard Drive Failure"},
    {0x5D, 0x31, (int)FAILURE,       "Data Channel Impending Failure - Drive Error Rate Too High"},
    {0x5D, 0x32, (int)FAILURE,       "Data Channel Impending Failure - Data Error Rate Too High"},
    {0x5D, 0x33, (int)FAILURE,       "Data Channel Impending Failure - Seek Error Rate Too High"},
    {0x5D, 0x34, (int)FAILURE,       "Data Channel Impending Failure - Too Many Block Reassigns"},
    {0x5D, 0x35, (int)FAILURE,       "Data Channel Impending Failure - Access Times Too High"},
    {0x5D, 0x36, (int)FAILURE,       "Data Channel Impending Failure - Start Unit Times Too High"},
    {0x5D, 0x37, (int)FAILURE,       "Data Channel Impending Failure - Channel Parametrics"},
    {0x5D, 0x38, (int)FAILURE,       "Data Channel Impending Failure - Controller Detected"},
    {0x5D, 0x39, (int)FAILURE,       "Data Channel Impending Failure - Throughput Performance"},
    {0x5D, 0x3A, (int)FAILURE,       "Data Channel Impending Failure - Seek Time Performance"},
    {0x5D, 0x3B, (int)FAILURE,       "Data Channel Impending Failure - Spin-Up Retry Count"},
    {0x5D, 0x3C, (int)FAILURE,       "Data Channel Impending Failure - Drive Calibration Retry Count"},
    {0x5D, 0x40, (int)FAILURE,       "Servo Impending Failure - General Hard Drive Failure"},
    {0x5D, 0x41, (int)FAILURE,       "Servo Impending Failure - Drive Error Rate Too High"},
    {0x5D, 0x42, (int)FAILURE,       "Servo Impending Failure - Data Error Rate Too High"},
    {0x5D, 0x43, (int)FAILURE,       "Servo Impending Failure - Seek Error Rate Too High"},
    {0x5D, 0x44, (int)FAILURE,       "Servo Impending Failure - Too Many Block Reassigns"},
    {0x5D, 0x45, (int)FAILURE,       "Servo Impending Failure - Access Times Too High"},
    {0x5D, 0x46, (int)FAILURE,       "Servo Impending Failure - Start Unit Times Too High"},
    {0x5D, 0x47, (int)FAILURE,       "Servo Impending Failure - Channel Parametrics"},
    {0x5D, 0x48, (int)FAILURE,       "Servo Impending Failure - Controller Detected"},
    {0x5D, 0x49, (int)FAILURE,       "Servo Impending Failure - Throughput Performance"},
    {0x5D, 0x4A, (int)FAILURE,       "Servo Impending Failure - Seek Time Performance"},
    {0x5D, 0x4B, (int)FAILURE,       "Servo Impending Failure - Spin-Up Retry Count"},
    {0x5D, 0x4C, (int)FAILURE,       "Servo Impending Failure - Drive Calibration Retry Count"},
    {0x5D, 0x50, (int)FAILURE,       "Spindle Impending Failure - General Hard Drive Failure"},
    {0x5D, 0x51, (int)FAILURE,       "Spindle Impending Failure - Drive Error Rate Too High"},
    {0x5D, 0x52, (int)FAILURE,       "Spindle Impending Failure - Data Error Rate Too High"},
    {0x5D, 0x53, (int)FAILURE,       "Spindle Impending Failure - Seek Error Rate Too High"},
    {0x5D, 0x54, (int)FAILURE,       "Spindle Impending Failure - Too Many Block Reassigns"},
    {0x5D, 0x55, (int)FAILURE,       "Spindle Impending Failure - Access Times Too High"},
    {0x5D, 0x56, (int)FAILURE,       "Spindle Impending Failure - Start Unit Times Too High"},
    {0x5D, 0x57, (int)FAILURE,       "Spindle Impending Failure - Channel Parametrics"},
    {0x5D, 0x58, (int)FAILURE,       "Spindle Impending Failure - Controller Detected"},
    {0x5D, 0x59, (int)FAILURE,       "Spindle Impending Failure - Throughput Performance"},
    {0x5D, 0x5A, (int)FAILURE,       "Spindle Impending Failure - Seek Time Performance"},
    {0x5D, 0x5B, (int)FAILURE,       "Spindle Impending Failure - Spin-Up Retry Count"},
    {0x5D, 0x5C, (int)FAILURE,       "Spindle Impending Failure - Drive Calibration Retry Count"},
    {0x5D, 0x60, (int)FAILURE,       "Firmware Impending Failure - General Hard Drive Failure"},
    {0x5D, 0x61, (int)FAILURE,       "Firmware Impending Failure - Drive Error Rate Too High"},
    {0x5D, 0x62, (int)FAILURE,       "Firmware Impending Failure - Data Error Rate Too High"},
    {0x5D, 0x63, (int)FAILURE,       "Firmware Impending Failure - Seek Error Rate Too High"},
    {0x5D, 0x64, (int)FAILURE,       "Firmware Impending Failure - Too Many Block Reassigns"},
    {0x5D, 0x65, (int)FAILURE,       "Firmware Impending Failure - Access Times Too High"},
    {0x5D, 0x66, (int)FAILURE,       "Firmware Impending Failure - Start Unit Times Too High"},
    {0x5D, 0x67, (int)FAILURE,       "Firmware Impending Failure - Channel Parametrics"},
    {0x5D, 0x68, (int)FAILURE,       "Firmware Impending Failure - Controller Detected"},
    {0x5D, 0x69, (int)FAILURE,       "Firmware Impending Failure - Throughput Performance"},
    {0x5D, 0x6A, (int)FAILURE,       "Firmware Impending Failure - Seek Time Performance"},
    {0x5D, 0x6B, (int)FAILURE,       "Firmware Impending Failure - Spin-Up Retry Count"},
    {0x5D, 0x6C, (int)FAILURE,       "Firmware Impending Failure - Drive Calibration Retry Count"},
    {0x5D, 0x73, (int)FAILURE,       "Media Impending Failure Endurance Limit Met"},
    {0x5D, 0xFF, (int)FAILURE,       "Failure Prediction Threshold Exceeded (False)"},
    {0x5E, 0x00, (int)SUCCESS,       "Low Power Condition On"},
    {0x5E, 0x01, (int)SUCCESS,       "Idle Condition Activated By Timer"},
    {0x5E, 0x02, (int)SUCCESS,       "Standby Condition Activated By Timer"},
    {0x5E, 0x03, (int)SUCCESS,       "Idle Condition Activated By Command"},
    {0x5E, 0x04, (int)SUCCESS,       "Standby Condition Activated By Command"},
    {0x5E, 0x05, (int)SUCCESS,       "Idle_B Condition Activated By Timer"},
    {0x5E, 0x06, (int)SUCCESS,       "Idle_B Condition Activated By Command"},
    {0x5E, 0x07, (int)SUCCESS,       "Idle_C Condition Activated By Timer"},
    {0x5E, 0x08, (int)SUCCESS,       "Idle_C Condition Activated By Command"},
    {0x5E, 0x09, (int)SUCCESS,       "Standby_Y Condition Activated By Timer"},
    {0x5E, 0x0A, (int)SUCCESS,       "Standby_Y Condition Activated By Command"},
    {0x5E, 0x41, (int)SUCCESS,       "Power State Change To Active"},
    {0x5E, 0x42, (int)SUCCESS,       "Power State Change To Idle"},
    {0x5E, 0x43, (int)SUCCESS,       "Power State Change To Standby"},
    {0x5E, 0x45, (int)SUCCESS,       "Power State Change To Sleep"},
    {0x5E, 0x47, (int)SUCCESS,       "Power State Change To Device Control"},
    {0x60, 0x00, (int)FAILURE,       "Lamp Failure"},
    {0x61, 0x00, (int)FAILURE,       "Video ascuisition Error"},
    {0x61, 0x01, (int)FAILURE,       "Unable To ascuire Video"},
    {0x61, 0x02, (int)FAILURE,       "Out Of Focus"},
    {0x62, 0x00, (int)FAILURE,       "Scan Head Positioning Error"},
    {0x63, 0x00, (int)FAILURE,       "End Of User Area Encountered On This Track"},
    {0x63, 0x01, (int)FAILURE,       "Packet Does Not Fit In Available Space"},
    {0x64, 0x00, (int)FAILURE,       "Illegal Mode For This Track"},
    {0x64, 0x01, (int)FAILURE,       "Invalid Packet Size"},
    {0x65, 0x00, (int)FAILURE,       "Voltage Fault"},
    {0x66, 0x00, (int)FAILURE,       "Automatic Document Feeder Cover Up"},
    {0x66, 0x01, (int)FAILURE,       "Automatic Document Feeder Lift Up"},
    {0x66, 0x02, (int)FAILURE,       "Document Jam In Automatic Document Feeder"},
    {0x66, 0x03, (int)FAILURE,       "Document Miss Feed Automatic In Document Feeder"},
    {0x67, 0x00, (int)FAILURE,       "Configuration Failure"},
    {0x67, 0x01, (int)FAILURE,       "Configuration Of Incapable Logical Units Failed"},
    {0x67, 0x02, (int)FAILURE,       "Add Logical Unit Failed"},
    {0x67, 0x03, (int)FAILURE,       "Modification Of Logical Unit Failed"},
    {0x67, 0x04, (int)FAILURE,       "Exchange Of Logical Unit Failed"},
    {0x67, 0x05, (int)FAILURE,       "Remove Of Logical Unit Failed"},
    {0x67, 0x06, (int)FAILURE,       "Attachment Of Logical Unit Failed"},
    {0x67, 0x07, (int)FAILURE,       "Creation Of Logical Unit Failed"},
    {0x67, 0x08, (int)FAILURE,       "Assign Failure Occurred"},
    {0x67, 0x09, (int)FAILURE,       "Multiply Assigned Logical Unit"},
    {0x67, 0x0A, (int)FAILURE,       "Set Target Port Groups Command Failed"},
    {0x67, 0x0B, (int)NOT_SUPPORTED, "ATA Device Feature Not Enabled"},
    {0x67, 0x0C, -1,                 "Command Rejected"},
    {0x67, 0x0D, -1,                 "Explicit Bind Not Allowed"},
    {0x68, 0x00, (int)FAILURE,       "Logical Unit Not Configured"},
    {0x68, 0x01, (int)FAILURE,       "Subsidiary Logical Unit Not Configured"},
    {0x69, 0x00, (int)FAILURE,       "Data Loss On Logical Unit"},
    {0x69, 0x01, (int)FAILURE,       "Multiple Logical Unit Failures"},
    {0x69, 0x02, (int)FAILURE,       "Parity/Data Mismatch"},
    ...
    {0x6E, 0x00, (int)FAILURE,       "Command To Logical Unit Failed"},
    {0x6F, 0x00, (int)FAILURE,       "Copy Protection Key Exchange Failure - Authentication Failure"},
    {0x6F, 0x01, (int)FAILURE,       "Copy Protection Key Exchange Failure - Key Not Present"},
    {0x6F, 0x02, (int)FAILURE,       "Copy Protection Key Exchange Failure - Key Not Established"},
    {0x6F, 0x03, (int)FAILURE,       "Read Of Scrambled Sector Without Authentication"},
    {0x6F, 0x04, (int)FAILURE,       "Media Region Code Is Mismatched To Logical Unit Region"},
    {0x6F, 0x05, (int)FAILURE,       "Drive Region Must Be Permanent/Region Reset Count Error"},
    {0x6F, 0x06, (int)FAILURE,       "Insufficient Block Count For Binding Nonce Recording"},
    {0x6F, 0x07, (int)FAILURE,       "Conflict In Binding Nonce Recording"},
    ...
    {0x72, 0x00, (int)FAILURE,       "Session Fixation Error"},
    {0x72, 0x01, (int)FAILURE,       "Session Fixation Error Writing Lead-In"},
    {0x72, 0x02, (int)FAILURE,       "Session Fixation Error Writing Lead-Out"},
    {0x72, 0x03, (int)FAILURE,       "Session Fixation Error - Incomplete Track In Session"},
    {0x72, 0x04, (int)FAILURE,       "Empty Or Partially Written Reserved Track"},
    {0x72, 0x05, (int)FAILURE,       "No More Track Reservations Allowed"},
    {0x72, 0x06, (int)FAILURE,       "RMZ Extension Is Not Allowed"},
    {0x72, 0x07, (int)FAILURE,       "No More Test Zone Extensions Are Allowed"},
    {0x73, 0x00, (int)FAILURE,       "CD Control Error"},
    ...
    {0x74, 0x00, (int)FAILURE,       "Security Error"},
    {0x74, 0x01, (int)FAILURE,       "Unable To Decrypt Data"},
    {0x74, 0x02, (int)FAILURE,       "Unencrypted Data Encountered While Decrypting"},
    {0x74, 0x03, (int)FAILURE,       "Incorrect Data Encryption Key"},
    {0x74, 0x04, (int)FAILURE,       "Cryptographic Integrity Validation Failed"},
    {0x74, 0x05, (int)FAILURE,       "Error Decrypting Data"},
    {0x74, 0x06, (int)FAILURE,       "Unknown Signature Verification Key"},
    {0x74, 0x07, (int)FAILURE,       "Encryption Parameters Not Useable"},
    {0x74, 0x08, (int)FAILURE,       "Digital Signature Validation Failure"},
    {0x74, 0x09, (int)FAILURE,       "Encryption Mode Mismatch On Read"},
    {0x74, 0x0A, (int)FAILURE,       "Encrypted Block Not Raw Read Enabled"},
    {0x74, 0x0B, (int)FAILURE,       "Incorrect Encryption Parameters"},
    {0x74, 0x0C, (int)FAILURE,       "Unable To Decrypt Parameter List"},
    {0x74, 0x0D, (int)FAILURE,       "Encryption Algorithm Disabled"},
    {0x74, 0x10, (int)FAILURE,       "SA Creation Parameter Value Invalid"},
    {0x74, 0x11, (int)FAILURE,       "SA Creation Parameter Value Rejected"},
    {0x74, 0x12, (int)FAILURE,       "Invalid SA Usage"},
    {0x74, 0x21, (int)FAILURE,       "Data Encryption Configuration Prevented"},
    {0x74, 0x30, (int)NOT_SUPPORTED, "SA Creation Parameter Not Supported"},
    {0x74, 0x40, (int)FAILURE,       "Authenticaion Failed"},
    {0x74, 0x61, (int)FAILURE,       "External Data Encryption Key Manager Access Error"},
    {0x74, 0x62, (int)FAILURE,       "External Data Encryption Key Manager Error"},
    {0x74, 0x63, (int)FAILURE,       "External Data Encryption Key Not Found"},
    {0x74, 0x64, (int)FAILURE,       "External Data Encryption Request Not Authorized"},
    {0x74, 0x6E, (int)FAILURE,       "External Data Encryption Control Timeout"},
    {0x74, 0x6F, (int)FAILURE,       "External Data Encryption Control Error"},
    {0x74, 0x71, (int)FAILURE,       "Logical Unit Access Not Authorized"},
    {0x74, 0x79, (int)FAILURE,       "Security Conflict In Translated Device"}
};
