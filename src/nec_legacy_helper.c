...
// ******************************************************************************************
//
// \file nec_legacy_helper.c   Implementation for NEC Legacy USB Pass-through
// CDBs
...
eReturnValues build_NEC_Legacy_CDB(uint8_t cdb[16], ataPassthroughCommand* ataCommandOptions)
{
    ...
    // set the sector count option (add force flag or something for this later if
    // we ever find out what it means since the documentation doesn't make much
    // sense - TJE)
    return ret;
}
