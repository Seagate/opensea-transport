...
//EOF PCIE ERROR INFORMATION
    ...
    typedef enum _eNvmeFeatures {
        ...
        NVME_FEAT_PREDICATABLE_LATENCY_MODE_CONFIG  = 0x13,
        NVME_FEAT_PREDICATABLE_LATENCY_MODE_WINDOW  = 0x14,
        NVME_FEAT_LBA_STATUS_INFORMATION_REPORT_INTERVAL    = 0x15,//NVM command set
        NVME_FEAT_HOST_BEHAVIOR_SUPPORT = 0x16,
        NVME_FEAT_SANITIZE_CONFIG       = 0x17,
        NVME_FEAT_ENDURANCE_GROUP_EVENT_CONFIGURATION   = 0x18,
        NVME_FEAT_IO_COMMAND_SET_PROFILE    = 0x19,
        NVME_FEAT_SPINUP_CONTROL    = 0x1A,
        //key value - 20h
        // 78h-7C = reserved for management features
        NVME_FEAT_ENHANCED_CONTROLLER_METADATA  = 0x7D,
        NVME_FEAT_CONTROLLER_METADATA   = 0x7E,
        NVME_FEAT_NAMESPACE_METADATA    = 0x7F,
