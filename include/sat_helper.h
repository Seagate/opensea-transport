...
#define SAT_T_LEN_XFER_FET                                                                                             \
    (0x01) // The transfer length is an unsigned integer specified in the FEATURES
           // (7:0) field.
#define SAT_T_LEN_XFER_SEC_CNT                                                                                         \
    (0x02)                            // The transfer length is an unsigned integer specified in the
