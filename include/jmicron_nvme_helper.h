...
#define JMICRON_NVME_PT_OPCODE                                                                                         \
    UINT8_C(0xA1) // NOTE: this is NOT a vendor unique opcode which will make data
                  // traces confusing and can confuse other devices that know this
                  // to mean SAT passthrough

#define JMICRON_NVME_NAMESTRING                                                                                        \
    "NVME" // signature used in various placed to validate the payload or returned
