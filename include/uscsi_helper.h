...
// This is the maximum timeout a command can use in uscsi passthrough with
// Solaris...18.2 hours
#define USCSI_MAX_CMD_TIMEOUT_SECONDS UINT16_MAX
    ...
    //  send_uscsi_io()
    //
    //! \brief   Description:  Function to send an IO using the Solaris uscsi
    //! passthrough
    //
    //  Entry:
    //!   \param[in] scsiIoCtx =  pointer to a scsiIoCtx struct which contains the
    //!   information necessary to send a command.
    //!
    //!
    //  Exit:
