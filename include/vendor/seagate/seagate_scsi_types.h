...
#define SEAGATE_SCSI_VENDOR_ID                                                                                         \
    "SEAGATE " // This is a case-sensitive match! Includes the space to exactly match inquiry data!
...
// Inquiry data also contains copyright notice: (Example: "Copyright (c) XXXX Seagate All rights reserved" where XXXX
// indicates the year the drive's firmware code was built)
...
#define SEAGATE_INQ_COPYRIGHT_LENGTH UINT8_C(48)
    ...
    typedef enum eSeagateLogPagesEnum // not subpages. Unique subpages should be in a different enum, similar to
                                      // protocol specific MP above
    {
