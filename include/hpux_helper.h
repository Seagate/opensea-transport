...
#define HPUX_MAX_CMD_TIMEOUT_SECONDS UINT_MAX
    ...
    // \param scsiIoCtx
    M_PARAM_RO(1) eReturnValues send_IO(ScsiIoCtx* scsiIoCtx);
    ...
    //
    //-----------------------------------------------------------------------------
    OPENSEA_TRANSPORT_API M_PARAM_RO(1) eReturnValues os_Device_Reset(const tDevice* device);
    ...
    //
    //-----------------------------------------------------------------------------
    OPENSEA_TRANSPORT_API M_PARAM_RO(1) eReturnValues os_Bus_Reset(const tDevice* device);
    ...
    M_PARAM_RW(1) eReturnValues send_NVMe_IO(nvmeCmdCtx* nvmeIoCtx);
