...
//! \file vm_nvme_mgmt.h
//! \brief Driver management interface of native nvme driver, shared by kernel and user space tools.
//! \copyright
//! Do NOT modify or remove this copyright and license
//!
//! Copyright (c) 2018-2025 Seagate Technology LLC and/or its Affiliates, All Rights Reserved
//!
...
VMK_ReturnStatus kernelCbSmartGet(vmk_MgmtCookies*             cookies,
                                  vmk_MgmtEnvelope*            envelope,
                                  vmk_uint32*                  nsID,
                                  struct nvmeSmartParamBundle* bundle);
VMK_ReturnStatus kernelCbIoctl(vmk_MgmtCookies*  cookies,
                               vmk_MgmtEnvelope* envelope,
                               vmk_uint32*       cmd,
                               struct usr_io*    uio);
VMK_ReturnStatus kernelCbErrInject(vmk_MgmtCookies*  cookies,
                                   vmk_MgmtEnvelope* envelope,
                                   ...
                                   vmk_uint32*       flag);
#    else
VMK_ReturnStatus kernelCbSmartGet(vmk_uint64                   cookie,
                                  vmk_uint64                   instanceId,
                                  vmk_uint32*                  nsID,
                                  struct nvmeSmartParamBundle* bundle);
VMK_ReturnStatus kernelCbIoctl(vmk_uint64 cookie, vmk_uint64 instanceId, vmk_uint32* cmd, struct usr_io* uio);
VMK_ReturnStatus kernelCbErrInject(vmk_uint64  cookie,
                                   vmk_uint64  instanceId,
                                   vmk_uint32* globalFlag,
                                   vmk_uint32* errType,
                                   vmk_uint32* likelyhood,
