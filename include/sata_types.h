...
// 
// \file sata_types.h
// \brief Defines types that are specific to SATA interface. Mostly FIS structures that may be used by some passthrough interfaces. This file should only have things unique to SATA transport.
...
extern "C"
{
    ...
    typedef struct _sataDataFis
    {
        ...
        //DWORD 1
        uint32_t nDWordsData[1];//This is variable length. up to 2048 DWords, so this struct should be variable size depending on the transfer. Because of this, we represent it like this.
