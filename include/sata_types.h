...
//
// \file sata_types.h
// \brief Defines types that are specific to SATA interface. Mostly FIS structures that may be used by some passthrough
// interfaces. This file should only have things unique to SATA transport.
