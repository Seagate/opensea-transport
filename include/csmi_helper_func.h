...
#    if defined(_WIN32)
    ...
    //
    //-----------------------------------------------------------------------------
    M_PARAM_RO(1) OPENSEA_TRANSPORT_API bool device_Supports_CSMI_With_RST(const tDevice* M_NONNULL device);
#    endif
    ...
    M_PARAM_RW(3)
    OPENSEA_TRANSPORT_API eReturnValues
    get_CSMI_RAID_Device_Count(uint32_t* M_NONNULL                      numberOfDevices,
                               uint64_t                                 flags,
                               ptrRaidHandleToScan M_NONNULL* M_NONNULL beginningOfList);

    //-----------------------------------------------------------------------------
    //
    //  get_CSMI_RAID_Device_List(const tDevice* M_NONNULL const ptrToDeviceList, uint32_t sizeInBytes, versionBlock
    //  ver, uint64_t flags, char **checkHandleList, uint32_t checkHandleListLength)
    //
    ...
    M_PARAM_RW(5)
    OPENSEA_TRANSPORT_API eReturnValues
    get_CSMI_RAID_Device_List(tDevice* M_NONNULL const                 ptrToDeviceList,
    ...
    //
    //-----------------------------------------------------------------------------
    M_NULL_TERM_STRING(1) M_PARAM_RO(1) OPENSEA_TRANSPORT_API bool is_CSMI_Handle(const char* M_NONNULL filename);
    ...
    //
    //-----------------------------------------------------------------------------
    M_PARAM_RW(1) OPENSEA_TRANSPORT_API eReturnValues close_CSMI_RAID_Device(tDevice* M_NONNULL device);
    ...
    //
    //-----------------------------------------------------------------------------
    M_PARAM_RO(1) OPENSEA_TRANSPORT_API void print_CSMI_Device_Info(const tDevice* M_NONNULL device);
    ...
    //-----------------------------------------------------------------------------
    M_NULL_TERM_STRING(1)
    M_PARAM_RO(1) OPENSEA_TRANSPORT_API eCSMISecurityAccess get_CSMI_Security_Access(const char* M_NONNULL driverName);
